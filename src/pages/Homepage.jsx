  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <footer className="bg-primary text-white">
        <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
          ...
          <div className="flex flex-col sm:items-end gap-2 text-sm text-white/55">
            <div className="flex items-center gap-2">
              <MapPin size={13} className="flex-shrink-0" />
              <span>Hilongos, Leyte 6524, Philippines</span>
            </div>
            <div className="flex items-center gap-2">
              <Phone size={13} />
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-red-300 font-medium">· Emergency: (053) 561-0002</span>
            </div>
          </div>
        </div>
